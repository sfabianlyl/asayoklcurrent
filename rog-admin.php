...
<?php $inputs=getLatestApplications(); $me=getName();?>
        ...
        <div class="col-9">
            <div class="tab-content" id="usersTabContent" style="min-height:1000px">
                <?php $j=1; foreach($inputs as $input): ?>
                    <div class="tab-pane fade <?=($j==1)?"show active":""?>" role="tabpanel" id="member-<?=$input["id"]?>" aria-labelledby="member-<?=$input["id"]?>-tab">
