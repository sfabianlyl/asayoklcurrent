...
<?php
    if(isset($_POST["submit"])){
        ...
        $spreadsheetId ='1tap9FsnY7SljTH0ppzwG9RPAkuKVtVkY49GdSvlBWLM';
        
        
        $lnlYear=$_POST["lnlDate"];
...
<div>
    <img src="Images/lnl-logo.png" class="w-100">
</div>


<div class="mb-5">
    <h3 class="text-center">Love and Life</h3>
    <p class="text-center"><i>Checkout our past Love&Life photos.</i></p>
</div>

<div class="row mb-5 download justify-content-around">
    <div class="col-lg-3 col-5">
        <a href="https://drive.google.com/drive/folders/1D_gxlU-a9gzKYscYiqOG6yo0dNEd8fD8?usp=sharing" target="_blank">
            <div class="row justify-content-center align-items-center py-3 shadow rounded">
                <div class="col-4">
                    <img src="Images/Google Photos.png" class="w-100"/>
                </div>
                <div class="col-7">
                    <span style="text-decoration: none !important; color:white;">Love&Life 2019</span>
                </div>
            </div>
        </a>
    </div>
    <div class="col-lg-3 col-5">
        <a href="https://drive.google.com/drive/folders/1EaUtFwxVeqeKfunbNHlFMU9JLS0igjwg?usp=sharing" target="_blank">
            <div class="row justify-content-center align-items-center py-3 shadow rounded">
                <div class="col-4">
                    <img src="Images/Google Photos.png" class="w-100"/>
                </div>
                <div class="col-7">
                    <span style="text-decoration: none !important; color:white;">Love&Life 2020</span>
                </div>
            </div>
        </a>
    </div>
...
<div class="row justify-content-center">
    <div class="col-lg-8 col-12">
        <form action="" method="POST">
            ...
            <div class="row mb-5">
                <div class="col-4">Tarikh & Masa (Date & Time)</div>
                <div class="col-8">20/2/2021 - 7pm</div>
            </div>

            <div class="row mb-5">
                <div class="col-4">Tahun bilakah anda hadiri Love&Life?<br>(In which year did you attend Love&Life?)</div>
                <div class="col-8">
                    <select class="form-control" name="lnlDate" id="lnlDateSelect">
                        <option>2020</option>
                        <option>2019</option>
                        <option>2018</option>
                        <option>2017</option>
                        ...
                        <option>2010</option>
                        <option>Other...</option>
                        <option>Never been to Love&Life</option>
                    </select>
                </div>
            </div>
